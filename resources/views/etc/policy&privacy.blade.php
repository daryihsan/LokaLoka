...
@push('head')
<meta name="description" content="Kebijakan Privasi Loka Loka yang menjelaskan cara kami mengumpulkan, menggunakan, dan melindungi data pribadi Anda.">
@endpush
...
@section('content')
    <article class="max-w-4xl mx-auto">
        ...
        <section id="informasi-yang-dikumpulkan" class="mb-6">
            ...
            <p class="text-gray-800">Kami dapat mengumpulkan data identitas, kontak, dan informasi transaksi saat Anda menggunakan layanan kami.</p>
        ...
        <section id="penggunaan-informasi" class="mb-6">
            ...
            <p class="text-gray-800">Kami menggunakan data untuk menyediakan layanan, memproses pesanan, meningkatkan pengalaman pengguna, serta untuk kepentingan keamanan dan kepatuhan.</p>
        </section>

        <section id="berbagi-informasi" class="mb-6">
            <h2 class="text-2xl font-roboto-slab text-green-darker mb-2">Berbagi Informasi</h2>
            <p class="text-gray-800">Kami dapat membagikan informasi kepada mitra tepercaya untuk pemrosesan pembayaran, pengiriman, dan kepatuhan hukum sesuai kebutuhan.</p>
        </section>

        <section id="keamanan-data" class="mb-6">
            <h2 class="text-2xl font-roboto-slab text-green-darker mb-2">Keamanan Data</h2>
            <p class="text-gray-800">Kami menerapkan langkah‑langkah teknis dan organisasi yang wajar untuk melindungi data Anda. Namun, tidak ada metode transmisi yang 100% aman.</p>
        </section>

        <section id="hak-pengguna" class="mb-6">
            <h2 class="text-2xl font-roboto-slab text-green-darker mb-2">Hak Pengguna</h2>
            <p class="text-gray-800">Anda dapat meminta akses, perbaikan, penghapusan, atau pembatasan pemrosesan data pribadi sesuai hukum yang berlaku.</p>
        </section>

        <section id="kontak" class="mb-6">
            <h2 class="text-2xl font-roboto-slab text-green-darker mb-2">Kontak</h2>
            <p class="text-gray-800">Untuk pertanyaan mengenai privasi, silakan hubungi kami melalui alamat kontak yang tercantum di situs.</p>
        </section>
    </article>
@endsection