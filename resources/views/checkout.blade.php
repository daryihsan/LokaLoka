...
<head>
    ...
    <style>
        ...
        .shipping-address p, .payment-options p {
            margin: 0;
            line-height: 1.6;
        }
    ...
    <div class="checkout-container">
        <div class="main-content">
                ...
                <div class="option-group">
                    ...
                    <label for="express">
                        <div class="option-details">
                            ...
                            <span>Estimasi 1 hari kerja</span>
                        </div>
            ...
            <div class="card">
                <div class="card-header">
                     <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="10" rx="2" ry="2"/><path d="M2 12h20"/></svg>
                    </span>
                    <h2>Metode Pembayaran</h2>
                </div>
                 <div class="option-group">
                    <input type="radio" id="bca" name="payment" checked>
                    <label for="bca">
                        <div class="option-details">
        ...
        <div class="order-summary">
            <div class="card">
                ...
                <div class="product-list">
                    ...
                    <div class="product-item">
                        <img src="https://placehold.co/70x70/e3d8c2/5c6641?text=Produk" alt="Kain Batik">
                        <div class="product-details">
