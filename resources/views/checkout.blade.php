...
<style>
    ...
    .checkout-container { max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 2fr 1fr; gap: 30px; }
    .main-content { display: flex; flex-direction: column; gap: 30px; }
    .card { background-color: var(--surface-color); border-radius: 15px; padding: 30px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); }
    .card-header { display: flex; align-items: center; gap: 15px; border-bottom: 1px solid var(--border-color); padding-bottom: 20px; margin-bottom: 20px; }
    .card-header .icon { color: var(--primary-color); }
    .card-header h2 { font-family: 'Roboto', sans-serif; font-weight: 700; font-size: 1.4em; margin: 0; }
    .shipping-address p { margin: 0; line-height: 1.6; }
    .shipping-address strong { display: block; margin-bottom: 5px; }
    .change-link { display: block; margin-top: 10px; color: var(--primary-color); font-weight: bold; text-decoration: none; font-size: 0.9em; }
    .option-group label { display: flex; align-items: center; padding: 15px; border: 1px solid var(--border-color); border-radius: 8px; margin-bottom: 10px; cursor: pointer; transition: border-color 0.3s, box-shadow 0.3s; }
    .option-group label:hover { border-color: var(--primary-color); }
    .option-group input[type="radio"] { display: none; }
    .option-group input[type="radio"]:checked + label { border-color: var(--primary-color); box-shadow: 0 0 8px rgba(92, 102, 65, 0.3); }
    ...
    .order-summary h1 { font-family: 'Roboto Slab', serif; font-size: 2em; margin-top: 0; margin-bottom: 5px; }
    ...
    .quantity-input { width: 50px; text-align: center; border: 1px solid var(--border-color); border-radius: 5px; padding: 5px; }
    .product-price { font-weight: bold; min-width: 80px; text-align: right; }
    .summary-calculation { border-top: 1px solid var(--border-color); padding-top: 20px; margin-top: 20px; display: flex; flex-direction: column; gap: 15px; }
    .summary-row { display: flex; justify-content: space-between; }
    .summary-total { font-size: 1.2em; font-weight: bold; }
    .checkout-button { width: 100%; padding: 15px; border: none; border-radius: 8px; background-color: var(--primary-color); color: white; font-family: 'Roboto', sans-serif; font-size: 1.1em; font-weight: bold; cursor: pointer; margin-top: 20px; transition: background-color 0.3s, transform 0.2s; }
