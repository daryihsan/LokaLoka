    ...
    <div class="checkout-container">
        ...
        <div class="main-content space-y-8">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    {{-- Tombol ubah alamat yang benar --}}
                    <button class="btn btn-link ml-auto text-sm" onclick="location.href='{{ route('alamat.form') }}'">Ubah
                        Alamat</button>
                </div>
                <div class="shipping-address">
                    ...
                    <p class="text-gray-600">
                        {{ session('telepon_penerima', $user->phone_number ?? '(Nomor tidak tersedia)') }}</p>
                ...
                <div class="card-header">
                    <span class="icon text-primary">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path
                                d="M10.29 3.86L11.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" />
            ...
            <div class="card">
                ...
                <div class="option-group">
                    ...
                    <label for="qris">
                        <div class="option-details"><strong>QRIS</strong><span>Bayar dengan QR code (Gopay, OVO, Dana,
                                dll)</span></div>
                    </label>
                    ...
                    <label for="transfer_bank">
                        <div class="option-details"><strong>Transfer Bank</strong><span>Pembayaran via Bank
                                Mandiri/BCA</span></div>
                    </label>

                    {{-- Opsi Pembayaran COD (Cash on Delivery) --}}
                    <input type="radio" id="cod" name="payment" data-method="cod">
                    <label for="cod">
                        <div class="option-details"><strong>COD (Bayar di Tempat)</strong><span>Pembayaran tunai saat barang
                                diterima</span></div>
                    </label>
                </div>
            </div>
        ...
        <div class="order-summary">
            <div class="card p-6 sticky top-8">
                ...
                <button class="btn btn-primary w-full mt-6 checkout-button" onclick="processCheckout()"> Bayar Sekarang
                </button>
            </div>
        </div>
