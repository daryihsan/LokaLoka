...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@700&family=Roboto:wght@400;700&family=Open+Sans:wght@400&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        .focus-ring {
            outline: none;
            box-shadow: 0 0 0 3px rgba(139, 157, 70, .35);
        }
