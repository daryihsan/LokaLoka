...
@section('content')
    <div class="min-h-screen text-green-darker font-open-sans bg-white">
        ...
        <main class="max-w-4xl mx-auto mt-10 p-6 bg-white rounded-2xl shadow-lg">
            <button onclick="history.back()" class="mb-4 text-sm text-gray-600 hover:text-green-darker font-medium">&larr;
                Kembali ke halaman sebelumnya</button>
                ...
                <div class="space-y-6">
                    <div class="mb-6">
                        ...
                        <img src="{{ $product->image_url }}"
                            ...
                            alt="Gambar Produk" class="rounded-lg shadow-md w-full object-cover">
                    </div>
                    ...
                    <form id="add-to-cart-form" onsubmit="addToCartFormSubmit(event)">
                        ...
                        <button type="submit" class="w-full bg-primary hover:bg-primary-dark text-white py-3
        ...
        'Stok Habis' : 'Tambah ke Keranjang' }}
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 font-medium text-lg">{{ $product->category->name ?? 'Tidak Berkategori' }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-700 font-medium leading-relaxed whitespace-pre-wrap">
...
@push('scripts')
    <script>
        // Ganti event listener agar memanggil fungsi baru untuk detail produk
        document.getElementById('add-to-cart-form')?.addEventListener('submit', async (event) => {
            ...
            // Gunakan fungsi addToCart yang sudah didefinisikan di homepage.blade.php
        ...
        function showToast(type, message) {
            // Pastikan menggunakan wadah notifikasi global yang baru
