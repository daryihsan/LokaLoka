...
@section('content')
    <div class="container-page-narrow">
        <div class="flex items-center justify-between mb-6">
            ...
            <button class="btn btn-secondary" onclick="window.location.href = '{{ route('homepage') }}'">
                Kembali
            </button>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <aside class="card p-6 h-max sticky top-24">
                ...
                <div id="summary-content" class="space-y-3 mb-6">
                    <div class="text-sm text-gray-600 flex justify-between"><span>Subtotal</span><span
                            id="sum-subtotal">Rp0</span></div>
                    <div class="text-sm text-gray-600 flex justify-between"><span>Ongkir (estimasi)</span><span
                            id="sum-shipping">Rp0</span></div>
                    <div class="text-base font-bold flex justify-between"><span>Total</span><span id="sum-total">Rp0</span>
                    </div>
                </div>
                <div id="checkout-section">
                    ...
                    <p class="text-xs text-gray-500 mt-3 text-center">Dengan melanjutkan, Anda menyetujui syarat dan
                        ketentuan kami</p>
                </div>
            </aside>
        </div>
...
@push('scripts')
    <script>
        ...
        async function renderCart() {
            ...
            // Menggunakan map dan join untuk render HTML
