...
class AdminController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        // ** Data Registrasi Pengguna Baru per Bulan **
    ...
    {
        // Pengecekan otorisasi admin (session check di awal file ini)
        ...
        // Menggunakan update dan mengembalikan hasil boolean dari update
        $updated = $user->update([
            'approved' => 1,
            'role' => 'customer'
        ]);
